  ...
  return (
    <div>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">The ABCs of Sports Training</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">Stance & Alignment</h3>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">Bat Control & Mechanics</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">Consistent Practice</h3>
                <p className="text-muted-foreground">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Beast Hack Training Stations?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">Portable Design</h3>
              <p className="text-sm text-muted-foreground">Easy setup anywhere - home, park, or field</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Durable construction for years of training</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">Space Efficient</h3>
              <p className="text-sm text-muted-foreground">Compact storage, maximum training value</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2">Multi-Sport Ready</h3>
              <p className="text-sm text-muted-foreground">Baseball, softball, and pickleball training</p>
            </div>
          </div>
        </div>
      </section>
